      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">For all locations</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Table>
            ...
            <TableBody>
              {Array.from({ length: 5 }).map((_, i) => (
                <TableRow key={i}>
                  <TableCell className="font-medium">BOK-{2023001 + i}</TableCell>
                  <TableCell>Paris City Tour</TableCell>
                  <TableCell>John Doe</TableCell>
                  <TableCell>2023-12-{10 + i}</TableCell>
                  <TableCell>
                    <div className="flex w-fit items-center rounded-full bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-600 dark:bg-emerald-400/10">
                      Confirmed
                    </div>
                  </TableCell>
